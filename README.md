...
## Project structure
game/ main.tscn / main.gd — menu, intro, spawning, score, popup dog bird.tscn / bird.gd — falling birds, click detection, whoosh sfx dog.tscn — popup dog sprite assets/ sounds/ — intro music, whoosh, etc. background.png — game background
